...
final class TrackingService {
    ...
    static let dummyTrackings: [TrackingListItem] = [
        TrackingListItem(
            ...
            events: [
                TrackingEvent(id: 101, trackerStatus: "INFORMATION_RECEIVED", mappedStatus: "registered", description: "고객님의 상품이 접수되었습니다.", eventTime: "2026-04-10T09:00:00Z", location: "서울 강남", lat: nil, lon: nil),
                TrackingEvent(id: 102, trackerStatus: "AT_PICKUP", mappedStatus: "pickedUp", description: "보내시는 고객님으로부터 상품을 인수받았습니다.", eventTime: "2026-04-10T14:10:00Z", location: "서울 강남터미널", lat: nil, lon: nil),
                TrackingEvent(id: 103, trackerStatus: "IN_TRANSIT", mappedStatus: "inTransitIn", description: "고객님의 상품이 배송지로 이동중입니다.", eventTime: "2026-04-10T21:30:00Z", location: "옥천HUB", lat: nil, lon: nil),
                TrackingEvent(id: 104, trackerStatus: "IN_TRANSIT", mappedStatus: "inTransitIn", description: "고객님의 상품이 배송지에 도착하였습니다.", eventTime: "2026-04-11T05:00:00Z", location: "부산북부터미널", lat: nil, lon: nil),
                TrackingEvent(id: 105, trackerStatus: "OUT_FOR_DELIVERY", mappedStatus: "outForDelivery", description: "배송담당자가 고객님의 상품을 배송할 예정입니다.", eventTime: "2026-04-11T09:40:00Z", location: "부산 해운대 집배점", lat: nil, lon: nil),
            ]
        ),
        TrackingListItem(
        ...
        TrackingListItem(
            ...
            events: [
                TrackingEvent(id: 301, trackerStatus: "INFORMATION_RECEIVED", mappedStatus: "registered", description: "고객님의 상품이 접수되었습니다.", eventTime: "2026-04-07T11:00:00Z", location: "인천 남동", lat: nil, lon: nil),
                TrackingEvent(id: 302, trackerStatus: "AT_PICKUP", mappedStatus: "pickedUp", description: "보내시는 고객님으로부터 상품을 인수받았습니다.", eventTime: "2026-04-07T18:00:00Z", location: "인천 남동터미널", lat: nil, lon: nil),
                TrackingEvent(id: 303, trackerStatus: "IN_TRANSIT", mappedStatus: "inTransitIn", description: "고객님의 상품이 배송지로 이동중입니다.", eventTime: "2026-04-08T02:00:00Z", location: "대전HUB", lat: nil, lon: nil),
                TrackingEvent(id: 304, trackerStatus: "OUT_FOR_DELIVERY", mappedStatus: "outForDelivery", description: "배송담당자가 고객님의 상품을 배송 중입니다.", eventTime: "2026-04-11T09:00:00Z", location: "대전 유성 집배점", lat: nil, lon: nil),
                TrackingEvent(id: 305, trackerStatus: "DELIVERED", mappedStatus: "delivered", description: "고객님의 상품이 배송완료 되었습니다. (문 앞)", eventTime: "2026-04-11T14:22:00Z", location: "대전 유성구", lat: nil, lon: nil),
            ]
        ),
        TrackingListItem(
        ...
        TrackingListItem(
            ...
            events: [
                TrackingEvent(id: 501, trackerStatus: "InfoReceived", mappedStatus: "registered", description: "Shipment information received by the carrier", eventTime: "2026-04-08T10:00:00Z", location: "Guangzhou", lat: 23.1291, lon: 113.2644),
                TrackingEvent(id: 502, trackerStatus: "InTransit", mappedStatus: "inTransitIn", description: "Departed from origin country, in transit to destination", eventTime: "2026-04-09T22:00:00Z", location: "Guangzhou Airport", lat: 23.3924, lon: 113.2988),
                TrackingEvent(id: 503, trackerStatus: "InTransit", mappedStatus: "inTransitIn", description: "Arrived at destination country airport", eventTime: "2026-04-11T06:30:00Z", location: "Incheon", lat: 37.4602, lon: 126.4407),
                TrackingEvent(id: 504, trackerStatus: "InTransit", mappedStatus: "inTransitIn", description: "Held by customs for import clearance", eventTime: "2026-04-11T16:00:00Z", location: "인천세관", lat: nil, lon: nil),
            ],
        ...
        TrackingListItem(
            ...
            events: [
                TrackingEvent(id: 601, trackerStatus: "InfoReceived", mappedStatus: "registered", description: "Shipment picked up from the sender", eventTime: "2026-04-06T09:00:00Z", location: "Berlin", lat: 52.52, lon: 13.405),
                TrackingEvent(id: 602, trackerStatus: "InTransit", mappedStatus: "inTransitIn", description: "Processed at DHL sorting facility, departed", eventTime: "2026-04-07T13:00:00Z", location: "Leipzig Hub", lat: 51.4236, lon: 12.2372),
                TrackingEvent(id: 603, trackerStatus: "InTransit", mappedStatus: "inTransitIn", description: "Customs clearance processing complete", eventTime: "2026-04-10T11:00:00Z", location: "인천세관", lat: nil, lon: nil),
                TrackingEvent(id: 604, trackerStatus: "OutForDelivery", mappedStatus: "outForDelivery", description: "With delivery courier, out for delivery today", eventTime: "2026-04-12T08:40:00Z", location: "서울 강남", lat: nil, lon: nil),
            ],
